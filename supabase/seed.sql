...
INSERT INTO products (id, category_id, slug, name, short_description, description, image_urls, base_turnaround_days, min_order_quantity, unit_type, is_popular, is_active, tags, display_order) VALUES
  ('b0000000-0000-4000-8000-000000000001', 'a0000000-0000-4000-8000-000000000002', 'carte-de-visite-recto', 'Carte de Visite (Recto Simple)', 'Carte de visite recto simple pelliculée, 350g.', 'Impression haute qualité sur papier 350g avec pelliculage. Parfait pour une première impression professionnelle au meilleur prix.', '["/images/products/CARTES-DE-VISITE_APESS.jpg"]'::jsonb, 2, 100, 'piece', true, true, ARRAY['carte', 'visite', 'pro', 'recto'], 1),
  ('b0000000-0000-4000-8000-000000000002', 'a0000000-0000-4000-8000-000000000002', 'carte-de-visite-recto-verso', 'Carte de Visite (Recto/Verso)', 'Carte de visite recto/verso pelliculée, 350g.', 'Maximisez votre espace de communication avec une impression recto/verso de qualité supérieure, papier 350g pelliculé.', '["/images/products/Carte-de-visite-avec-du-vernis-sélectif-UV.webp"]'::jsonb, 2, 100, 'piece', true, true, ARRAY['carte', 'visite', 'pro', 'recto-verso'], 2),
  ('b0000000-0000-4000-8000-000000000003', 'a0000000-0000-4000-8000-000000000002', 'flyer-a5-recto', 'Flyer A5 (Recto Simple)', 'Distribution massive pour vos campagnes.', 'Impression de flyers A5 en recto simple. L''outil idéal pour une communication rapide et abordable.', '["/images/products/Screenshot_20260415_145335_WhatsAppBusiness.jpg"]'::jsonb, 3, 100, 'piece', false, true, ARRAY['flyer', 'promo'], 3),
  ('b0000000-0000-4000-8000-000000000004', 'a0000000-0000-4000-8000-000000000002', 'flyer-a5-recto-verso', 'Flyer A5 (Recto/Verso)', 'Distribution massive pour vos campagnes, imprimé des deux côtés.', 'Impression de flyers A5 en recto/verso pour diffuser un maximum d''informations.', '["/images/products/Depliants.webp"]'::jsonb, 3, 100, 'piece', true, true, ARRAY['flyer', 'promo'], 4),
  ('b0000000-0000-4000-8000-000000000005', 'a0000000-0000-4000-8000-000000000002', 'depliant-a4-3-volets', 'Dépliant A4 (3 volets)', 'Plaquette commerciale pelliculée, 6 pages.', 'Le format standard par excellence pour présenter votre entreprise ou vos services en détail.', '["/images/products/Depliant-3-volets.jpg"]'::jsonb, 4, 100, 'piece', true, true, ARRAY['depliant', 'plaquette', 'commercial'], 5),
  ('b0000000-0000-4000-8000-000000000006', 'a0000000-0000-4000-8000-000000000002', 'depliant-a3-4-volets', 'Dépliant A3 (4 volets)', 'Grand format pelliculé, 8 pages.', 'Idéal pour les menus de restaurant ou les présentations très détaillées.', '["/images/products/Dépliant-Format-3-volets-roulés.webp"]'::jsonb, 5, 100, 'piece', false, true, ARRAY['depliant', 'menu', 'grand format'], 6),
  ('b0000000-0000-4000-8000-000000000007', 'a0000000-0000-4000-8000-000000000002', 'papier-en-tete-a4', 'Papier à en-tête A4', 'Pour votre correspondance officielle.', 'Papier A4 personnalisé aux couleurs de votre entreprise.', '["/images/products/Papier ANTETE.jpg"]'::jsonb, 3, 100, 'piece', false, true, ARRAY['papier', 'lettre', 'courrier'], 7),
  ('b0000000-0000-4000-8000-000000000008', 'a0000000-0000-4000-8000-000000000002', 'bloc-notes-a5', 'Bloc-notes A5', 'Carnet de 50 feuilles détachables.', 'Idéal comme cadeau d''entreprise ou pour l''usage interne de vos équipes.', '["/images/products/Note-Bloc-S01-scaled.jpg"]'::jsonb, 5, 10, 'piece', false, true, ARRAY['carnet', 'bureau', 'goodies'], 8),
  ('b0000000-0000-4000-8000-000000000009', 'a0000000-0000-4000-8000-000000000002', 'calendrier-chevalet-simple', 'Calendrier Chevalet Simple', '2 faces carton tout bois, impression quadri.', 'Le calendrier de bureau classique et économique.', '["/images/products/calendrier chevalet.jpg"]'::jsonb, 7, 100, 'piece', true, true, ARRAY['calendrier', 'bureau', 'fin d''année'], 9),
  ('b0000000-0000-4000-8000-000000000010', 'a0000000-0000-4000-8000-000000000002', 'calendrier-chevalet-spirale', 'Calendrier Chevalet 7 feuillets', 'Reliure spirale, 250g couché brillant recto/verso.', 'Un calendrier premium avec une page par mois (ou bimestriel) relié par spirale métallique.', '["/images/products/Agenda003-scaled.jpg"]'::jsonb, 7, 100, 'piece', false, true, ARRAY['calendrier', 'bureau', 'premium'], 10),
  ('b0000000-0000-4000-8000-000000000011', 'a0000000-0000-4000-8000-000000000002', 'chemise-a-rabats', 'Chemise à Rabats', 'Pochette porte-documents A4 personnalisée.', 'Présentez vos devis et contrats avec élégance grâce à nos chemises à rabats sur mesure.', '["/images/products/chemises à rabat.jpg"]'::jsonb, 5, 100, 'piece', true, true, ARRAY['dossier', 'bureau', 'pro'], 11),
  ('b0000000-0000-4000-8000-000000000012', 'a0000000-0000-4000-8000-000000000002', 'calendrier-bancaire', 'Calendrier Bancaire', 'Contrecollé sur carton rigide, grand format.', 'Le calendrier indéchirable et rigide à poser ou à suspendre. Visibilité maximale toute l''année.', '["/images/products/calendrier bancaire.webp"]'::jsonb, 7, 50, 'piece', false, true, ARRAY['calendrier', 'cadeau', 'rigide'], 12),
  ('b0000000-0000-4000-8000-000000000013', 'a0000000-0000-4000-8000-000000000002', 'carte-pvc-fidelite', 'Carte PVC (Fidélité / Accès)', 'Format carte bancaire, plastique rigide.', 'Cartes de fidélité, badges d''accès ou cartes de membre ultra-résistantes avec vernis de protection.', '["/images/products/Carte-PVC-vernis.webp"]'::jsonb, 4, 50, 'piece', false, true, ARRAY['carte', 'plastique', 'fidélité'], 13)
ON CONFLICT (slug) DO NOTHING;
...
-- ============================================================
INSERT INTO products (id, category_id, slug, name, short_description, description, image_urls, base_turnaround_days, min_order_quantity, unit_type, is_popular, is_active, tags, display_order) VALUES
  ('b0000000-0000-4000-8000-000000000019', 'a0000000-0000-4000-8000-000000000004', 'tee-shirt-personnalise', 'Tee-shirt Personnalisé', 'Impression ou flocage sur T-shirt coton.', 'T-shirt confortable personnalisé à vos couleurs pour vos équipes ou événements.', '["/images/products/Textiles.webp"]'::jsonb, 4, 10, 'piece', true, true, ARRAY['vêtement', 'flocage', 'équipe'], 1),
  ('b0000000-0000-4000-8000-000000000020', 'a0000000-0000-4000-8000-000000000004', 'polo-personnalise', 'Polo Pilote / APEX', 'Polo haut de gamme pour les professionnels.', 'Une image soignée pour vos équipes avec ces polos brodés ou imprimés.', '["/images/products/Polo.webp"]'::jsonb, 5, 10, 'piece', true, true, ARRAY['vêtement', 'premium', 'broderie'], 2),
  ('b0000000-0000-4000-8000-000000000021', 'a0000000-0000-4000-8000-000000000004', 'gilet-simple', 'Gilet Simple', 'Gilet de sécurité ou de terrain personnalisé.', 'Gilet classique idéal pour les équipes sur le terrain ou l''événementiel.', '["/images/products/gilet.webp"]'::jsonb, 4, 10, 'piece', false, true, ARRAY['sécurité', 'terrain'], 3),
  ('b0000000-0000-4000-8000-000000000022', 'a0000000-0000-4000-8000-000000000004', 'gilet-vip-poches', 'Gilet VIP avec poches', 'Gilet premium multi-poches personnalisé.', 'Le summum du vêtement de terrain pour vos responsables de chantier ou d''événement.', '["/images/products/Gilet VIP.jpg"]'::jsonb, 4, 10, 'piece', false, true, ARRAY['premium', 'chantier', 'terrain'], 4),
  ('b0000000-0000-4000-8000-000000000023', 'a0000000-0000-4000-8000-000000000004', 'casquette-dtf', 'Casquette DTF', 'Casquette avec impression numérique DTF.', 'Des couleurs éclatantes et sans limite pour votre logo sur le front de la casquette.', '["/images/products/Casquette.webp"]'::jsonb, 3, 10, 'piece', true, true, ARRAY['goodies', 'tête', 'impression'], 5),
  ('b0000000-0000-4000-8000-000000000024', 'a0000000-0000-4000-8000-000000000004', 'casquette-broderie', 'Casquette Broderie', 'Casquette avec broderie haute qualité.', 'Un rendu luxueux, en relief et ultra-durable pour votre marque.', '["/images/products/Casquette.webp"]'::jsonb, 5, 10, 'piece', false, true, ARRAY['goodies', 'premium', 'fils'], 6),
  ('b0000000-0000-4000-8000-000000000025', 'a0000000-0000-4000-8000-000000000004', 'tote-bag', 'Tote Bag', 'Sac en toile écologique personnalisé.', 'L''objet promotionnel par excellence, utile au quotidien et parfait pour la visibilité de votre logo.', '["/images/products/Tote BAG.png"]'::jsonb, 4, 10, 'piece', true, true, ARRAY['sac', 'goodies', 'écologique'], 7)
ON CONFLICT (slug) DO NOTHING;
